...
var _chunkNXK6DY4Rcjs = require('./chunk-NXK6DY4R.cjs');
...
var _markdownexit = require('markdown-exit');
...
function createMarkdown(options) {
  ...
  const setupPromise = (async () => {
    const md = _markdownexit.createMarkdownExit.call(void 0, {
      html: true,
      linkify: true,
      typographer: true,
...
var _require = typeof _chunkNXK6DY4Rcjs.__require === "undefined" ? _module.createRequire.call(void 0, _chunkNXK6DY4Rcjs.importMetaUrl) : _chunkNXK6DY4Rcjs.__require;
...
function resolveOptions(userOptions) {
  ...
  const markdownOptions = _nullishCoalesce(_nullishCoalesce(userOptions.markdownOptions, () => ( userOptions.markdownItOptions)), () => ( {}));
  const markdownUses = _nullishCoalesce(_nullishCoalesce(userOptions.markdownUses, () => ( userOptions.markdownItUses)), () => ( []));
  const markdownSetup = _nullishCoalesce(_nullishCoalesce(userOptions.markdownSetup, () => ( userOptions.markdownItSetup)), () => ( noop));
