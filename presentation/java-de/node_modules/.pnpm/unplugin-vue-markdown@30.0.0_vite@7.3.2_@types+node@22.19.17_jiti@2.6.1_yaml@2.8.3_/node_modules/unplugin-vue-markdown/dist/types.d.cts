...
import MarkdownExit, { MarkdownExitOptions, PluginSimple, PluginWithOptions } from 'markdown-exit';
export { default as MarkdownExit, MarkdownExitOptions } from 'markdown-exit';
...
interface Options {
     ...
     */
    markdownUses?: (PluginSimple | [PluginSimple | PluginWithOptions<any>, any] | any)[];
    /**
     ...
     */
    markdownItUses?: (PluginSimple | [PluginSimple | PluginWithOptions<any>, any] | any)[];
    /**
...
export type { Frontmatter, MarkdownEnv, MetaProperty, Options, ResolvedOptions };
