...
🤷 **Don't trust any LLM**
<br/>the LLM doesn't do what you want

* 🎯 **Small tasks**
<br>one prompt, one clear goal

* 🗄️ **Make prompts individually testable**
<br>cache during development, integration tests

* 🔁 **Retries**
<br> for structured output


* 🚀 **Keep at it**
<br/> the field moves daily
